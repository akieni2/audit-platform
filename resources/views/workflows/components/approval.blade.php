<div class="space-y-4">
    <div class="rounded-2xl border border-[rgba(201,174,255,0.22)] bg-[rgba(28,15,39,0.72)] p-5">
        ...
        <p class="mt-2 text-sm text-[#D8B4FE]">Une approbation explicite est attendue sur cette étape. Vous pouvez ouvrir le stage ou utiliser les actions runtime ci-dessous.</p>
    </div>
